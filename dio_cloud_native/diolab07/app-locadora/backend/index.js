...
app.post('/api/locacao', async (req, res) => {
  ...
  try {
    ...
    const serviceBusConnection = ""//await secretClient.getSecret("ServiceBusConnectionString"); # Colocar a string de conexão do Service Bus aqui ou usar o .env para armazenar a string de conexão
